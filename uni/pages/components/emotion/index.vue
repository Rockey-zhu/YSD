<template>
	...
	-->
		...
		<!-- <view class="emojiList" 
		    ...
		    <image src="../../../static/message/img/tab/add2.png" @tap="addEmojiPackage"
			...
			<image src="../../../static/message/img/tab/setting.png" @tap="settingEmoji"
...
<style scoped>
	@import url("../../../static/message/css/vue-emoji.css");
