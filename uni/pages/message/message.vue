<template>
	<view :class="curThemeType">
		<nav-bar :title="lang.message" backState="2000"></nav-bar>
					...
					<block v-if="row.type=='system'" >
						<view class="system">
							...
							<view v-if="row.msg.type=='redEnvelope'" class="red-envelope">
								<image src="/static/message/img/red-envelope-chat.png"></image>
								{{row.msg.content.text}}
							</view>
						</view>
					</block>
						...
						<view class="my" v-if="row.msg.userinfo.uid==myuid">
							...
							<view class="left">
								...
								<view v-if="row.msg.type=='redEnvelope'" class="bubble red-envelope" @tap="openRedEnvelope(row.msg,index)">
									<image src="/static/message/img/red-envelope.png"></image>
									<view class="tis">
										<!-- 点击开红包 -->
									</view>
									<view class="blessing">
		...
		<!-- 抽屉栏 -->
		<view class="popup-layer" :class="popupLayerClass" @touchmove.stop.prevent="discard" style="margin-bottom: 50px;">
			<!-- 表情 --> 
			...
			<view class="more-layer" :class="{hidden:hideMore}">
				<view class="list">
					...
					<!-- <view class="box" @tap="weizhi">
						...
						src="../../static/message/img/more/weizhi.png"></image>
					</view>	 -->	
					<!-- <view class="box" @tap="yuyinshuru">
						<image style="font-size:16px;width: 32px; height: 32px;" 
						src="../../static/message/img/more/yuyinshuru.png"></image>
					</view> -->
					<view class="box" @tap="meShouchang">
						<image style="font-size:16px;width: 32px; height: 32px;" 
						src="../../static/message/img/more/wenjian.png"></image>
					</view>
					<view class="box" @tap="mewenjian">
						<image style="font-size:16px;width: 32px; height: 32px;" 
						src="../../static/message/img/more/userinfo.png"></image>
					</view>
			...
			<view class="layer" @touchmove.stop.prevent="discard">
				<view class="open-redenvelope">
					<view class="top">
						...
						<image src="/static/message/img/im/face/face_1.jpg"></image>
					</view>
...
<script type="module">
	...
	import emojiData from "../../static/message/emoji/emojiData.js";
	...
	export default {
		...
		onShow(){
			...
			uni.getStorage({
				...
				success:  (res)=>{
					...
					lastid++;
					let row = {type:"user",msg:{id:lastid,type:"redEnvelope",time:nowDate.getHours()+":"+nowDate.getMinutes(),userinfo:{uid:0,username:"大黑哥",face:"/static/message/img/face.jpg"},content:{blessing:res.data.blessing,rid:Math.floor(Math.random()*1000+1),isReceived:false}}};
					this.screenMsg(row);
		...
		methods:{
			...
			sendMsg(content,type){
				...
				let lastid = this.msgList[this.msgList.length-1].msg.id;
				lastid++;
				let msg = {type:'user',msg:{id:lastid,time:nowDate.getHours()+":"+nowDate.getMinutes(),type:type,userinfo:{uid:0,username:"大黑哥",face:"/static/message/img/face.jpg"},content:content}}
				// 发送消息
				this.screenMsg(msg);
				// 定时器模拟对方回复,三秒
				setTimeout(()=>{
...
<style lang="scss">
	@import "@/static/message/HM-chat/css/style.scss"; 
</style>
